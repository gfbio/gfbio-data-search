...
export const environment = {
  ...
  // Matomo Analytics - disabled in staging to keep analytics data clean
  matomo: {
    siteId: 5,
  ...
  apiUrl: "https://staging.search.gfbio.dev/api",
  context: "/gfbio",
  searchUrl: "/search",
  ...
  textAlertSemSearchError:
    "A connection error occured. Please reduce the amount of search terms or try the search again.",
  textAlertWordLength:
    "please choose a word longer than 4 letters to use the * in semantic search",
  textAlertBasketErrorDownload:
  ...
  textTooltipBasketMetadataNotAvailable:
    "metadata are not available for download",
  textTooltipBasketMultimediaAvailable: "multimedia are available for download",
  textTooltipBasketMultimediaNotAvailable:
    "multimedia are not available for download",
  textTooltipBasketRemove: "remove dataset from basket",
  textTooltipBasketRemoveSure:
    "Are you sure that you want to empty the basket?",
  textTooltipBasketEmpty: "Please select a dataset from the search result.",
  textTSWidgetInfo:
    "Your search query is expanded with relational terms obtained from GFBio's " +
  ...
  noCoordinates:
    "This dataset has no coordinates and can not be located on the map.",
  vatTooltip: "This dataset can be transfered to VAT.",
  datacenterTooltips: {
    SNSB:
      "This dataset is provided by Staatliche Naturwissenschaftliche " +
    ...
    ZFMK:
      "This dataset is provided by Zoological Research Museum Alexander Koenig; Leibniz " +
    ...
    PANGAEA:
      "This dataset is provided by Data Publisher for Earth; Environmental Science  (PANGAEA).",
    DSMZ:
      "This dataset is provided by Leibniz Institute DSMZ; German Collection of Microorganisms " +
